...
def draw_graph(nodes, edges, width, height, text, out_filename):
    ...
    for e in edges:
        ...
        l1 = [21, 357, 843, 45, 965, 834, 986, 829, 825, 822, 987, 639, 22, 1310, 977, 199, 200, 678, 17, 727, 16, 205,
              220, 1696, 224, 1169, 222, 437, 15, 340, 14, 13, 12, 908, 476, 345, 690, 344, 346, 243, 241, 1789, 683,
              93, 1729, 1020, 1721, 1019, 1016, 1725]

        if e.source_id in l1:
            lines.append(((sx, sy), (tx, ty), e.max_speed, e.source_id, e.target_id, (255, 0, 0)))
        else:
            lines.append(((sx, sy), (tx, ty), e.max_speed, e.source_id, e.target_id, (0, 0, 255)))
    ...
    for line_data in lines:
        ...
        # draw line
        draw.line(line, fill=line_data[5])
